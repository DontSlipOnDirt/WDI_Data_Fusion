...
/**
 * {@link EvaluationRule} for the isbn of {@link Book}s. The rule simply
 * compares the isbn of two {@link Book}s and returns true, in case they
 * are identical.
 *
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class IsbnEvaluationRule extends EvaluationRule<Book, Attribute> {
