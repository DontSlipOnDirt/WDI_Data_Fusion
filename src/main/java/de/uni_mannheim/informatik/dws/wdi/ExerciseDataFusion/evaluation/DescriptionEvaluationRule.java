...
/**
 * {@link EvaluationRule} for the Description of {@link Book}s. The rule simply
 * compares the Description of two {@link Book}s and returns true, in case they
 * are identical.
 *
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class DescriptionEvaluationRule extends EvaluationRule<Book, Attribute> {
    ...
    public boolean isEqual(Book record1, Book record2, Attribute schemaElement) {
        if(record1.getDescription()== null && record2.getDescription()==null)
            ...
            return record1.getDescription().equals(record2.getDescription());
    }
