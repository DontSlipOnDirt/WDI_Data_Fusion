...
/**
 * {@link AttributeValueFuser} for the CoverImage of {@link Book}s.
 *
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class CoverImageFuserFavourSource extends AttributeValueFuser<String, Book, Attribute> {

    public CoverImageFuserFavourSource() {
    ...
    public void fuse(RecordGroup<Book, Attribute> group, Book fusedRecord, Processable<Correspondence<Attribute, Matchable>> schemaCorrespondences, Attribute schemaElement) {
        ...
        fusedRecord.setCoverImg(fused.getValue());
        fusedRecord.setAttributeProvenance(Book.COVER_IMG,
