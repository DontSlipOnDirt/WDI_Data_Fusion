...
/**
 * {@link EvaluationRule} for the Language of {@link Book}s. The rule simply
 * compares the Language of two {@link Book}s and returns true, in case they
 * are identical.
 *
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class LanguageEvaluationRule extends EvaluationRule<Book, Attribute> {
