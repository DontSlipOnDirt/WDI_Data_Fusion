 ...
 * 
 */
public class DateFuserClusteredVote extends AttributeValueFuser<LocalDateTime, Book, Attribute> {

	public DateFuserClusteredVote() {
		super(new ClusteredVote<LocalDateTime, Book, Attribute>(new NormalisedDateSimilarity(),1.0));
	}
