...
/**
 * {@link AttributeValueFuser} for the Language of {@link Book}s.
 *
 * @author Oliver Lehmberg (oli@dwslab.de)
 *
 */
public class LanguageFuserFavourSource extends AttributeValueFuser<String, Book, Attribute> {

    public LanguageFuserFavourSource() {
